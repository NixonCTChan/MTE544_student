...
class localization(Node):
    ...
    def __init__(self, localizationType=rawSensor):
        ...
        # TODO May need to change for in person!
...
if __name__ == "__main__":
    ...
    init(args=sys.argv)  # Init ros2 with cmd line
    node = localization()  # Instantiate class
    try:
        spin(node)  # start, or allow exit without crashing
